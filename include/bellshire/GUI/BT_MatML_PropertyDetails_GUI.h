...
namespace bellshire::GUI {
    ...
    class PropertyDetails_GUI_Base : public MatML_GUI_Base, public PropertyDetails_Base
    {
    protected:
    ...
    public:
        ...
        ID_GUI* GetPropertyDetails_ID_GUI();
        wxTextCtrl* GetPropertyDetailsTypeTextCtrl();

        static wxNotebook* Create(wxWindow* parent,
            ID_GUI*& PropertyDetails_ID_GUI,
            wxTextCtrl*& PropertyDetailsTypeTextCtrl
        );
        static wxWindow* CreatePropertyDetailsPanel(wxWindow* parent,
            ID_GUI*& PropertyDetails_ID_GUI,
            wxTextCtrl*& PropertyDetailsTypeTextCtrl
        );
        ...
        static wxString GetTreeLabel(const observer_ptr<PropertyDetails> element);
