...
// For compilers that don't support pre-compilation, include "wx/wx.h"
#include "wx/wxprec.h"
...
#define wxID_MatMLTreeCtrl 1002
	...
	public:
		...
		wxMenuBar* GetMenuBar1();/*!<Main Menu Bar*/
		wxMenu* GetFileMenu();
		wxMenuItem* GetNewMenuItem();
		wxMenuItem* GetOpenMenuItem();
		wxMenuItem* GetSaveMenuItem();
		wxMenuItem* GetSaveAsMenuItem();
		wxMenuItem* GetExportMaterialMenuItem();
		wxMenuItem* GetExportMaterialBranchMenuItem();
		wxMenuItem* GetImportMaterialBranchMenuItem();
		wxMenuItem* GetExitMenuItem();
		wxMenu* GetEditMenu();
		wxMenuItem* GetEditMenuPreferencesItem();
		wxMenuItem* GetSortClass1MenuItem();
		wxMenuItem* GetIsolateMaterialBranchMenuItem();
		wxMenuItem* GetExitIsolateMaterialBranchMenuItem();
		wxMenu* GetViewMenu();
		wxMenu* GetHelpMenu();
		wxMenuItem* GetAboutMenuItem();
		wxStatusBar* GetStatusBar1();
		wxSplitterWindow* GetSplitter1();
		wxPanel* GetPanel68();
		TreeCtrlSorted* GetMatMLTreeCtrl();
		wxPanel* GetMultiPanel();
		wxPanel* GetIntroPanel();
		wxStaticBitmap* GetLogoBitmap();
		wxStaticText* GetIntroStaticText();
		MatMLDropTarget* GetDropTarget();
		Unit* GetData();
		DnDMatMLData* GetDndMatMLData();
		observer_ptr<GUI> GetGUI();/*!< MatML GUIs Classes*/
