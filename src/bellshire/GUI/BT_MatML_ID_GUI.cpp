...
//#include "bellshire/BT_MatML_GatherIDRefs.h"
...
wxPanel* ID_GUI_Base::GetGUI()
{
	return m_GUI;
}

wxButton* ID_GUI_Base::GetGenerateUuidButton()
{
	return m_GenerateUuidButton;
}

wxTextCtrl* ID_GUI_Base::GetIDTextCtrl()
{
	return m_IDTextCtrl;
}

wxCheckBox* ID_GUI_Base::GetReplaceIDRefs()
{
	return m_ReplaceIDRefs;
}
...
wxPanel* ID_GUI_Base::Create(wxWindow* parent, wxButton*& GenerateUuidButton, wxTextCtrl*& IDTextCtrl, wxCheckBox*& ReplaceIDRefs)
{
	...
	ReplaceIDRefs = new wxCheckBox(IDCtrlPanel, wxID_ANY, wxT("Replace all IDREFs and maintain connectivity"), wxDefaultPosition, wxDefaultSize, 0);
...
void ID_GUI_Base::Update( const observer_ptr<Material> element)
{
	if (element) {
		wxString str;
...
void ID_GUI_Base::Update(const observer_ptr < ComponentDetails> element)
{
	if (element) {
		wxString str;
...
void ID_GUI_Base::Update(const observer_ptr < TestConditionDetails> element)
{
	if (element) {
		wxString str;
...
void ID_GUI_Base::Update(const observer_ptr < SpecimenDetails> element)
{
	if (element) {
		wxString str;
...
void ID_GUI_Base::Update(const observer_ptr < SourceDetails> element)
{
	if (element) {
		wxString str;
...
void ID_GUI_Base::Update(const observer_ptr < PropertyDetails> element)
{
	if (element) {
		wxString str;
...
void ID_GUI_Base::Update(const observer_ptr < ParameterDetails> element)
{
	if (element) {
		wxString str;
...
void ID_GUI_Base::Update(const observer_ptr < MeasurementTechniqueDetails> element)
{
	if (element) {
		wxString str;
		str << _std2wx(element->id());
...
void ID_GUI_Base::Update(const observer_ptr < DataSourceDetails> element)
{
	if (element) {
		wxString str;
...
void ID_GUI_Base::Update(const observer_ptr < AuthorityDetails> element)
{
	if (element) {
		wxString str;
...
TreeCtrlSorted* ID_GUI::GetMatMLTreeCtrl()
{
	return m_MatMLTreeCtrl;
}

observer_ptr<MatML_Doc> ID_GUI::GetMatMLDoc()
{
	return m_MatMLDoc;
}
...
/// </summary>
/// <param name="MatMLTreeCtrl"></param>
void ID_GUI::SetEvtHandlerVar(TreeCtrlSorted*& MatMLTreeCtrl, observer_ptr<MatML_Doc> MatMLDoc)
{
...
/// </summary>
/// <param name="MatMLTreeCtrl"></param>
void ID_GUI::SetMatMLDoc(const observer_ptr<MatML_Doc>& matml_doc)
{
	if (matml_doc) {
...
void ID_GUI::SwapIDRefs(const observer_ptr<MatML_Doc> matml_doc, xml_schema::idref& oldid, xml_schema::idref& newid)
{
	if (!oldid.empty()) {
		...
		//Gather IdRef
		MatML_Doc_GUI::TraverseMatMLTree(matml_doc, func);
...
bool ID_GUI::Warning()
{
		std::string msg("Replacing an ID will break connectivity!\n Do you want to proceed?");
...
std::string ID_GUI::GetUUIDLabel()
{
	...
	uuidlabel.append(cast_stream< std::string>("-"));

	uuidlabel.append(cast_stream< std::string>(iduuid));
...
void ID_GUI::GenerateUuid(const observer_ptr<Material> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<ComponentDetails> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<TestConditionDetails> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<SpecimenDetails> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<SourceDetails> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<PropertyDetails> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<ParameterDetails> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<MeasurementTechniqueDetails> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<DataSourceDetails> element)
{
	if (element) {
...
void ID_GUI::GenerateUuid(const observer_ptr<AuthorityDetails> element)
{
	if (element) {
...
void ID_GUI::OnIDTextCtrl(wxCommandEvent& event)
{
	...
	try {
		...
		if (Element != 0) {
			...
			wxString str(GetIDTextCtrl()->GetValue());
