...
wxStaticBitmap* Intro_GUI_Base::GetLogoBitmap()
{
	return m_logobitmap;
}
...
wxNotebook* Intro_GUI_Base::Create(wxWindow* parent, wxStaticBitmap* logobitmap)
{
	...
	wxWindow* IntroPanel(CreateIntroPanel(IntroNotebook, logobitmap));
...
wxWindow* Intro_GUI_Base::CreateIntroPanel(wxWindow* parent, wxStaticBitmap* logobitmap)
{
	/// Creates the MatML data panel
	wxScrolledWindow* IntroPanel = new wxScrolledWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
