...
wxPanel* PropertyDetails_Display_GUI::GetGUI()
{
	return m_GUI;
}
wxTextCtrl* PropertyDetails_Display_GUI::GetPropertyDetailsNameTextCtrl()
{
	return m_PropertyDetailsNameTextCtrl;
}
wxTextCtrl* PropertyDetails_Display_GUI::GetPropertyDetailsUnitsTextCtrl()
{
	return m_PropertyDetailsUnitsTextCtrl;
}
wxTextCtrl* PropertyDetails_Display_GUI::GetPropertyDetailsNotesTextCtrl()
{
	return m_PropertyDetailsNotesTextCtrl;
}
;
...
void PropertyDetails_Display_GUI::Update( const observer_ptr<PropertyData> element)
{
