...
ID_GUI* ParameterDetails_GUI_Base::GetParameterDetails_ID_GUI()
{
	return m_ParameterDetails_ID_GUI;
}
...
wxNotebook* ParameterDetails_GUI_Base::Create(wxWindow* parent,
...
)
{
	...
	wxWindow* ParameterDetailsPanel(CreateParameterDetailsPanel(ParameterDetailsNotebook,
		ParameterDetails_ID_GUI
	));
...
wxWindow* ParameterDetails_GUI_Base::CreateParameterDetailsPanel(wxWindow* parent,
	ID_GUI*& ParameterDetails_ID_GUI
)
{
	wxScrolledWindow* ParameterDetailsPanel = new wxScrolledWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
	...
	return ParameterDetailsPanel;
}

void ParameterDetails_GUI_Base::Update( const observer_ptr<ParameterDetails> element)
{
...
wxString ParameterDetails_GUI_Base::GetTreeLabel(const observer_ptr<ParameterDetails> element)
{
	::std::string label;
...
TreeCtrlSorted* ParameterDetails_GUI::GetMatMLTreeCtrl()
{
	return m_MatMLTreeCtrl;
}

::boost::any ParameterDetails_GUI::GetMatMLItemToCopy()
{
...
/// </summary>
/// <param name="MatMLTreeCtrl"></param>
void ParameterDetails_GUI::SetEvtHandlerVar(TreeCtrlSorted*& MatMLTreeCtrl, observer_ptr<MatML_Doc>& MatMLDoc)
{
	m_ParameterDetails_ID_GUI->SetEvtHandlerVar(MatMLTreeCtrl, MatMLDoc);
...
void ParameterDetails_GUI::OnBumpDown(wxCommandEvent& event)
{
	...
	IndividualBumpDownHavingId< ParameterDetails,
		Metadata,
...
void ParameterDetails_GUI::OnBumpUp(wxCommandEvent& event)
{
	...
	IndividualBumpUpHavingId< ParameterDetails,
		Metadata,
		Metadata::ParameterDetails_sequence,
		ParameterDetails_GUI,
		&Metadata::ParameterDetails
