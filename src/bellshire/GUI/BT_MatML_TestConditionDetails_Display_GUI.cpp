...
wxPanel* TestConditionDetails_Display_GUI::GetGUI()
{
	return m_GUI;
}
wxTextCtrl* TestConditionDetails_Display_GUI::GetTestConditionDetailsNotesTextCtrl()
{
	return m_TestConditionDetailsNotesTextCtrl;
}
;
...
void TestConditionDetails_Display_GUI::Update(const observer_ptr< PropertyData> element)
{
	if (element) {
