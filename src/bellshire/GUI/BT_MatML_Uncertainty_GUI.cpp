...
wxTextCtrl* Uncertainty_GUI_Base::GetUncertaintyDistributionTypeTextCtrl()
{
	return m_UncertaintyDistributionTypeTextCtrl;
}

wxTextCtrl* Uncertainty_GUI_Base::GetUncertaintyNum_Std_DevTextCtrl()
{
	return m_UncertaintyNum_Std_DevTextCtrl;
}

wxTextCtrl* Uncertainty_GUI_Base::GetUncertaintyPercentileTextCtrl()
{
	return m_UncertaintyPercentileTextCtrl;
}

wxTextCtrl* Uncertainty_GUI_Base::GetUncertaintyConfidenceLevelTextCtrl()
{
	return m_UncertaintyConfidenceLevelTextCtrl;
}

wxChoice* Uncertainty_GUI_Base::GetUncertaintyScaleChoice()
{
	return m_UncertaintyScaleChoice;
}
...
wxNotebook* Uncertainty_GUI_Base::Create(wxWindow* parent, 
...
)
{
	...
	wxWindow* UncertaintyPanel(CreateUncertaintyPanel(UncertaintyNotebook,
		UncertaintyDistributionTypeTextCtrl,
		UncertaintyNum_Std_DevTextCtrl,
		UncertaintyPercentileTextCtrl,
...
wxWindow* Uncertainty_GUI_Base::CreateUncertaintyPanel(wxWindow* parent,
	wxTextCtrl*& UncertaintyDistributionTypeTextCtrl,
	wxTextCtrl*& UncertaintyNum_Std_DevTextCtrl,
	wxTextCtrl*& UncertaintyPercentileTextCtrl,
	wxTextCtrl*& UncertaintyConfidenceLevelTextCtrl,
...
)
{
	...
	wxScrolledWindow* UncertaintyPanel = new wxScrolledWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
...
void Uncertainty_GUI_Base::Update(const observer_ptr< Uncertainty> element)
{
	wxString str;
...
wxString Uncertainty_GUI_Base::GetTreeLabel(const observer_ptr<Uncertainty> element)
{
	wxString str;
	str << wxT("Uncertainty");
...
TreeCtrlSorted* Uncertainty_GUI::GetMatMLTreeCtrl()
{
	return m_MatMLTreeCtrl;
}

::boost::any Uncertainty_GUI::GetMatMLItemToCopy()
{
