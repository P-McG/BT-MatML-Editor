...
wxPanel* DataSourceDetails_Display_GUI::GetGUI()
{
	return m_GUI;
}
wxTextCtrl* DataSourceDetails_Display_GUI::GetDataSourceDetailsNameTextCtrl()
{
	return m_DataSourceDetailsNameTextCtrl;
}
wxTextCtrl* DataSourceDetails_Display_GUI::GetDataSourceDetailsUnitsTextCtrl()
{
	return m_DataSourceDetailsUnitsTextCtrl;
}
wxTextCtrl* DataSourceDetails_Display_GUI::GetDataSourceDetailsNotesTextCtrl()
{
	return m_DataSourceDetailsNotesTextCtrl;
}
...
void DataSourceDetails_Display_GUI::Update( const observer_ptr<PropertyData> element)
{
