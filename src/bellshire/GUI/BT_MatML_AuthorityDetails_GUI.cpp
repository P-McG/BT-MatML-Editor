...
AuthorityDetails_GUI_Base::AuthorityDetails_GUI_Base()
	:m_AuthorityDetails_ID_GUI(nullptr)
{
...
wxNotebook* AuthorityDetails_GUI_Base::Create(wxWindow* parent, ID_GUI*& AuthorityDetails_ID_GUI)
{
	...
	wxWindow* AuthorityDetailsPanel(CreateAuthorityDetailsPanel(AuthorityDetailsNotebook, AuthorityDetails_ID_GUI));
...
wxWindow* AuthorityDetails_GUI_Base::CreateAuthorityDetailsPanel(wxWindow* parent, 
	ID_GUI*& AuthorityDetails_ID_GUI
	)
{

	wxScrolledWindow* AuthorityDetailsPanel = new wxScrolledWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
	...
	return AuthorityDetailsPanel;
}

void AuthorityDetails_GUI_Base::Update( const observer_ptr<AuthorityDetails> element)
{
...
ID_GUI* AuthorityDetails_GUI_Base::GetAuthorityDetails_ID_GUI()
{
	return m_AuthorityDetails_ID_GUI;
}

wxString AuthorityDetails_GUI_Base::GetTreeLabel(const observer_ptr<AuthorityDetails> element)
{
	::std::string label;
...
void AuthorityDetails_GUI::SetEvtHandlerVar(TreeCtrlSorted*& MatMLTreeCtrl, observer_ptr<MatML_Doc>& MatMLDoc)
{
	SetMatMLTreeCtrl(MatMLTreeCtrl);
	GetAuthorityDetails_ID_GUI()->SetEvtHandlerVar(m_MatMLTreeCtrl, MatMLDoc);
}
