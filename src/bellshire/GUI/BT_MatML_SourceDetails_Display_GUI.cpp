...
wxPanel* SourceDetails_Display_GUI::GetGUI()
{
	return m_GUI;
}
wxTextCtrl* SourceDetails_Display_GUI::GetSourceDetailsNameTextCtrl()
{
	return m_SourceDetailsNameTextCtrl;
}
wxTextCtrl* SourceDetails_Display_GUI::GetSourceDetailsNotesTextCtrl()
{
	return m_SourceDetailsNotesTextCtrl;
}
;
...
void SourceDetails_Display_GUI::Update(const observer_ptr<Source> element)
{
	if (element) {
