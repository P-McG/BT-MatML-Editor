...
wxPanel* SpecimenDetails_Display_GUI::GetGUI()
{
	return m_GUI;
}
wxTextCtrl* SpecimenDetails_Display_GUI::GetSpecimenDetailsNameTextCtrl()
{
	return m_SpecimenDetailsNameTextCtrl;
}
wxTextCtrl* SpecimenDetails_Display_GUI::GetSpecimenDetailsNotesTextCtrl()
{
	return m_SpecimenDetailsNotesTextCtrl;
}
;
...
void SpecimenDetails_Display_GUI::Update( const observer_ptr<PropertyData> element)
{
	if (element) {
