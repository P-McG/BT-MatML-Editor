...
wxTextCtrl* Value_GUI_Base::GetTextCtrl()
{
	return m_TextCtrl;
}

wxChoice* Value_GUI_Base::GetFormatChoice()
{
	return m_FormatChoice;
}

wxButton* Value_GUI_Base::GetValidationButton()
{
	return m_ValidationButton;
}

wxCheckBox* Value_GUI_Base::GetValidationNewLineRemovalCheckBox()
{
...
)
{
	...
	wxWindow* ValuePanel(CreateValuePanel(ValueNotebook,
		ValueTextCtrl,
		FormatChoice,
		ValidationButton,
...
wxWindow* Value_GUI_Base::CreateValuePanel(wxWindow* parent,
	wxTextCtrl*& ValueTextCtrl,
	wxChoice*& FormatChoice,
	wxButton*& ValidationButton,
	wxCheckBox*& ValidationNewLineRemovalCheckBox
)
{
	...
	wxScrolledWindow* ValuePanel = new wxScrolledWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
...
void Value_GUI_Base::Update(const observer_ptr<Value> element)
{
...
wxString Value_GUI_Base::GetTreeLabel(const observer_ptr<Value> element)
{
	wxString str;
	str << wxT("Value");
...
TreeCtrlSorted* Value_GUI::GetMatMLTreeCtrl()
{
