...
ID_GUI* PropertyDetails_GUI_Base::GetPropertyDetails_ID_GUI()
{
	return m_PropertyDetails_ID_GUI;
}

wxTextCtrl* PropertyDetails_GUI_Base::GetPropertyDetailsTypeTextCtrl()
{
	return m_PropertyDetailsTypeTextCtrl;
}
...
wxNotebook* PropertyDetails_GUI_Base::Create(wxWindow* parent, 
...
)
{
	...
	wxWindow* PropertyDetailsPanel(CreatePropertyDetailsPanel(PropertyDetailsNotebook,
		PropertyDetails_ID_GUI,
		PropertyDetailsTypeTextCtrl
	));
...
wxWindow* PropertyDetails_GUI_Base::CreatePropertyDetailsPanel(wxWindow* parent,
	ID_GUI*& PropertyDetails_ID_GUI,
	wxTextCtrl*& PropertyDetailsTypeTextCtrl
)
{

	wxScrolledWindow* PropertyDetailsPanel = new wxScrolledWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
...
void PropertyDetails_GUI_Base::Update( const observer_ptr<PropertyDetails> element)
{
	wxString str;
...
wxString PropertyDetails_GUI_Base::GetTreeLabel(const observer_ptr<PropertyDetails> element)
{
	::std::string label;
...
TreeCtrlSorted* PropertyDetails_GUI::GetMatMLTreeCtrl()
{
	return m_MatMLTreeCtrl;
}

::boost::any PropertyDetails_GUI::GetMatMLItemToCopy()
{
...
/// </summary>
/// <param name="MatMLTreeCtrl"></param>
void PropertyDetails_GUI::SetEvtHandlerVar(TreeCtrlSorted*& MatMLTreeCtrl, observer_ptr<MatML_Doc>& MatMLDoc)
{
