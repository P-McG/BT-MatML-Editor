...
SpecimenDetails_GUI_Base::SpecimenDetails_GUI_Base()
	:m_SpecimenDetails_ID_GUI(nullptr),
	m_SpecimenDetailsTypeTextCtrl(nullptr)
{
...
ID_GUI* SpecimenDetails_GUI_Base::GetSpecimenDetails_ID_GUI()
{
	return m_SpecimenDetails_ID_GUI;
}

wxTextCtrl* SpecimenDetails_GUI_Base::GetSpecimenDetailsTypeTextCtrl()
{
	return m_SpecimenDetailsTypeTextCtrl;
}
...
wxNotebook* SpecimenDetails_GUI_Base::Create(wxWindow* parent, 
...
)
{
	...
	wxWindow* SpecimenDetailsPanel(CreateSpecimenDetailsPanel(SpecimenDetailsNotebook,
		SpecimenDetails_ID_GUI,
		SpecimenDetailsTypeTextCtrl
	));
...
wxWindow* SpecimenDetails_GUI_Base::CreateSpecimenDetailsPanel(wxWindow* parent,
	ID_GUI*& SpecimenDetails_ID_GUI,
	wxTextCtrl*& SpecimenDetailsTypeTextCtrl
)
{

	wxScrolledWindow* SpecimenDetailsPanel = new wxScrolledWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
	...
	return SpecimenDetailsPanel;
}

void SpecimenDetails_GUI_Base::Update(const observer_ptr <SpecimenDetails> element)
{
	wxString str;
...
wxString SpecimenDetails_GUI_Base::GetTreeLabel(const observer_ptr<SpecimenDetails> element)
{
	::std::string label;
...
TreeCtrlSorted* SpecimenDetails_GUI::GetMatMLTreeCtrl()
{
	return m_MatMLTreeCtrl;
}

::boost::any SpecimenDetails_GUI::GetMatMLItemToCopy()
{
...
/// </summary>
/// <param name="MatMLTreeCtrl"></param>
void SpecimenDetails_GUI::SetEvtHandlerVar(TreeCtrlSorted*& MatMLTreeCtrl, observer_ptr<MatML_Doc>& MatMLDoc)
{
...
void SpecimenDetails_GUI::OnBumpDown(wxCommandEvent& event)
{
	...
	IndividualBumpDownHavingId< SpecimenDetails,
		Metadata,
...
void SpecimenDetails_GUI::OnBumpUp(wxCommandEvent& event)
{
	...
	IndividualBumpUpHavingId< SpecimenDetails,
		Metadata,
		Metadata::SpecimenDetails_sequence,
		SpecimenDetails_GUI,
		&Metadata::SpecimenDetails
