...
wxPanel* MeasurementTechniqueDetails_Display_GUI::GetGUI()
{
	return m_GUI;
}
wxTextCtrl* MeasurementTechniqueDetails_Display_GUI::GetMeasurementTechniqueDetailsNameTextCtrl()
{
	return m_MeasurementTechniqueDetailsNameTextCtrl;
}
wxTextCtrl* MeasurementTechniqueDetails_Display_GUI::GetMeasurementTechniqueDetailsNotesTextCtrl()
{
	return m_MeasurementTechniqueDetailsNotesTextCtrl;
}
;
...
void MeasurementTechniqueDetails_Display_GUI::Update( const observer_ptr<PropertyData> element)
{
	if (element) {
