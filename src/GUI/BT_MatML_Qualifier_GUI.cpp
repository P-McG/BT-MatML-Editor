...
)
{
	...
	wxScrolledWindow* QualifierPanel = new wxScrolledWindow(QualifierNotebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
...
void Qualifier_GUI_Base::Update( Qualifier* element)
{
...
wxTreeItemId Qualifier_GUI_Base::SetupMatMLTreeCtrl(TreeCtrlSorted*& MatMLTreeCtrl,
