...
)
{
	...
	wxScrolledWindow* DataPanel = new wxScrolledWindow(DataNotebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
...
void Data_GUI_Base::Update( Data* element)
{
...
wxTreeItemId Data_GUI_Base::SetupMatMLTreeCtrl(TreeCtrlSorted*& MatMLTreeCtrl,
...
void Data_GUI::OnDataTextCtrlKillFocus(wxCommandEvent& event)
{
	...
	m_DataTextCtrl->TransferDataFromWindow();
