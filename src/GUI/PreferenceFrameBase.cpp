...
void PreferenceFrameBase::CreateGeneralPanel()
{
	...
	wxFlexGridSizer* fgSizer115 = new wxFlexGridSizer(8, 2, 0, 0);
	...
	m_MatMLDataSelection = new wxCheckBox(m_GeneralPanel, wxID_ANY, wxT("Click to show MatML Data tab first \n(application restart required)"), wxDefaultPosition, wxDefaultSize, 0);
